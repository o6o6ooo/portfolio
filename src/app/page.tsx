      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap justify-start gap-3 lg:justify-end">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex h-12 items-center justify-center rounded-full border border-black/10 bg-white/70 px-5 text-sm font-semibold text-[var(--fg-secondary)] shadow-[0_1px_3px_rgba(0,0,0,0.04)] backdrop-blur-xl transition-colors duration-200 hover:bg-[#f5f5f7] sm:px-6 sm:text-base"
          >
            Learn More
          </a>
          {item.link ? (
            <a
              ...
              className="inline-flex h-12 items-center justify-center rounded-full border border-[var(--apple-blue)] bg-[var(--apple-blue)] px-5 text-sm font-semibold text-white shadow-[0_2px_8px_rgba(0,136,255,0.18)] backdrop-blur-xl transition-colors duration-200 hover:bg-[#0077e6] sm:px-6 sm:text-base"
            >
              Download
            </a>
          ) : null}
